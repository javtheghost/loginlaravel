    ...
    <body class="antialiased">
        <div class=" relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-white-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <h1 style="color:#357DB9" class=" center text-bold">Seguridad web</h1>
                    <div class="center">
                        <img src="https://www.segurilatam.com/wp-content/uploads/sites/5/2021/04/guia-oea-twitter-900x600.jpg" alt="img">
                    </div>
                </div>
        </div>
    </body>
